...
MAINTAINER Luis Felipe Mileo <mileo@kmee.com.br>

ENV ODOO_SRC_PATH="/home/odoo/odoo-src"
ENV ODOO_DEST="/home/odoo/odoo"
ENV ODOO_REPOSITORY_URL="https://github.com/odoo/odoo.git"
ENV ODOO_REPOSITORY_BRANCH="12.0"
...
RUN git clone -b "$REPOSITORY_BRANCH" --single-branch --depth 1 "$ODOO_REPOSITORY_URL" "$ODOO_SRC_PATH"
